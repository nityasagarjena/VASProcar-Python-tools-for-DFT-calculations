...
print("#######################################################")
print("Deseja dividir os pontos-k em varios arquivos KPOINTS? ")
print("#######################################################")
print("## [0] NAO                                           ##")
print("## [1] SIM                                           ##")
print("#######################################################")
...
if (split == 1):
   estrutura = 0
   print("#######################################################")
   print("Quantos pontos-k deseja por arquivo KPOINTS? ==========")
   print("#######################################################")
   print("# Observacao:                                          ")
   print("# O VASProcar somente consegue unificar calculos, onde ")
   print("# todos os arquivos PROCAR possuam exatamente a mesma  ")
   print("# quantidade de pontos-k.                              ")
   print("# Alem disso, o ponto-k inicial do PROCAR.n deve ser   ")
   print("# exatamente igual ao ponto-k final do PROCAR.(n-1)    ")
   print("# Edite Os arquivos KPOINTS, respeitando estas normas. ")
   print("#######################################################")
...
if (split == 1):
   ...
   for i in range(1,(passo+1)):
       ...
       if (tipo == 1):
          kpoints.write(f'Plano_2D VASProcar \n')
       if (tipo == 2):
          kpoints.write(f'Malha_3D VASProcar \n')
