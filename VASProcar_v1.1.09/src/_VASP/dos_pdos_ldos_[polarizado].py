...
dos_u_tot = [0]*(NEDOS+1)  # DOS Total (Up)
dos_d_tot = [0]*(NEDOS+1)  # DOS Total (Down)
ldos_u    = [0]*(NEDOS+1)  # DOS Local (Up)
ldos_d    = [0]*(NEDOS+1)  # DOS Local (Down)
lpdos_u   = [[[0]*(NEDOS+1) for i in range(ni+1)] for j in range(n_orb+1)]  # DOS Local e Projetada (Up)
lpdos_d   = [[[0]*(NEDOS+1) for i in range(ni+1)] for j in range(n_orb+1)]  # DOS Local e Projetada (Down)

pdos_u_S_tot = [0]*(NEDOS+1)  # pdos_S Total (Up)
pdos_d_S_tot = [0]*(NEDOS+1)  # pdos_S Total (Down)
pdos_u_P_tot = [0]*(NEDOS+1)  # pdos_P Total (Up)
pdos_d_P_tot = [0]*(NEDOS+1)  # pdos_P Total (Down)
pdos_u_D_tot = [0]*(NEDOS+1)  # pdos_D Total (Up)
pdos_d_D_tot = [0]*(NEDOS+1)  # pdos_D Total (Down)
lpdos_u_S    = [0]*(NEDOS+1)  # Local pdos_S (Up)
lpdos_d_S    = [0]*(NEDOS+1)  # Local pdos_S (Down)
lpdos_u_P    = [0]*(NEDOS+1)  # Local pdos_P (Up)
lpdos_d_P    = [0]*(NEDOS+1)  # Local pdos_P (Down)
lpdos_u_D    = [0]*(NEDOS+1)  # Local pdos_D (Up)
lpdos_d_D    = [0]*(NEDOS+1)  # Local pdos_D (Down)

lpdos_u_tot = [[0]*(NEDOS+1) for i in range(n_orb+1)]  # Local pdos Total (Up)
lpdos_d_tot = [[0]*(NEDOS+1) for i in range(n_orb+1)]  # Local pdos Total (Down)
...
for k in range (1,(NEDOS+1)):
    ...
    if (esc == 0):
       ...
       dos_pdos_ldos.write(f' {pdos_u_S_tot[k]} 0.0 {pdos_u_P_tot[k]} 0.0 {pdos_u_D_tot[k]} 0.0')
    if (esc == 1):
       dos_pdos_ldos.write(f'{energia[k]} {dos_u_tot[k]} {ldos_u[k]}')
       dos_pdos_ldos.write(f' {pdos_u_S_tot[k]} {lpdos_u_S[k]} {pdos_u_P_tot[k]} {lpdos_u_P[k]} {pdos_u_D_tot[k]} {lpdos_u_D[k]}')
    if (lorbit > 10):
...
for k in range (1,(NEDOS+1)):
    ...
    if (esc == 0):
       ...
       dos_pdos_ldos.write(f' {pdos_d_S_tot[k]} 0.0 {pdos_d_P_tot[k]} 0.0 {pdos_d_D_tot[k]} 0.0')
    if (esc == 1):
       dos_pdos_ldos.write(f'{energia[k]} {dos_d_tot[k]} {ldos_d[k]}')
       dos_pdos_ldos.write(f' {pdos_d_S_tot[k]} {lpdos_d_S[k]} {pdos_d_P_tot[k]} {lpdos_d_P[k]} {pdos_d_D_tot[k]} {lpdos_d_D[k]}')
    if (lorbit > 10):
