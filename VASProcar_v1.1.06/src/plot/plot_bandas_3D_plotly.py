...
if (dir_output != ''):
   print(" ")
   print("===========================================================")
   print("= Edite o Plot3D por meio dos seguintes seguintes arquivos ")
   print("= Bandas_3D_matplotlib.py e Bandas_3D_plotly.py gerados na ")
   print("= pasta output/Bandas_3D ==================================")   
   print("===========================================================")
