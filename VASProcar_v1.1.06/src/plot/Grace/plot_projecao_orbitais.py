        ...
        for wp in range (1, (n_procar+1)):
            for point_k in range (1, (nk+1)):
                for Band_n in range (1, (nb+1)):
                    ...
                    #------------------------------------------------------
                    if (j == 1): # Orbital S
                       orbital = orb_S[wp][point_k][Band_n]*peso_total
                    #-------------------- lorbit = 10 ---------------------
                    if (j == 2 and lorbit == 10): # Orbital P
                       orbital = orb_P[wp][point_k][Band_n]*peso_total
                    if (j == 3 and lorbit == 10): # Orbital D
                       orbital = orb_D[wp][point_k][Band_n]*peso_total
                    #-------------------- lorbit >= 11 --------------------                     
                    ...
                    #------------------------------------------------------
                    if (j == 4): # Orbital Px 
                       orbital = orb_Px[wp][point_k][Band_n]*peso_total
                    if (j == 5): # Orbital Py 
                       orbital = orb_Py[wp][point_k][Band_n]*peso_total
                    if (j == 6): # Orbital pz 
                       orbital = orb_Pz[wp][point_k][Band_n]*peso_total
                    #------------------------------------------------------
                    if (j == 7): # Orbital Dxy 
                       orbital = orb_Dxy[wp][point_k][Band_n]*peso_total
                    if (j == 8): # Orbital Dyz 
                       orbital = orb_Dyz[wp][point_k][Band_n]*peso_total
                    if (j == 9): # Orbital Dz2 
                       orbital = orb_Dz2[wp][point_k][Band_n]*peso_total
                    if (j == 10): # Orbital Dxz 
                       orbital = orb_Dxz[wp][point_k][Band_n]*peso_total
                    if (j == 11): # Orbital Dx2 
                       orbital = orb_Dx2[wp][point_k][Band_n]*peso_total
                    #------------------------------------------------------                       
