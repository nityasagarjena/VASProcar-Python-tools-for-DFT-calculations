        ...
        for wp in range (1, (n_procar+1)):
            for point_k in range (1, (nk+1)):
                for Band_n in range (1, (nb+1)):
                    ...
                    #------------------------------------------------------
                    if (j == 4): # Orbital Px 
                       orb_Px[wp][point_k][Band_n] = soma_orb[wp][4][point_k][Band_n]
                    if (j == 5): # Orbital Py 
                       orb_Py[wp][point_k][Band_n] = soma_orb[wp][2][point_k][Band_n]
                    if (j == 6): # Orbital pz 
                       orb_Pz[wp][point_k][Band_n] = soma_orb[wp][3][point_k][Band_n]
                    #------------------------------------------------------
                    if (j == 7): # Orbital Dxy 
                       orb_Dxy[wp][point_k][Band_n] = soma_orb[wp][5][point_k][Band_n]
                    if (j == 8): # Orbital Dyz 
                       orb_Dyz[wp][point_k][Band_n] = soma_orb[wp][6][point_k][Band_n]
                    if (j == 9): # Orbital Dz2 
                       orb_Dz2[wp][point_k][Band_n] = soma_orb[wp][7][point_k][Band_n]
                    if (j == 10): # Orbital Dxz 
                       orb_Dxz[wp][point_k][Band_n] = soma_orb[wp][8][point_k][Band_n]
                    if (j == 11): # Orbital Dx2 
                       orb_Dx2[wp][point_k][Band_n] = soma_orb[wp][9][point_k][Band_n]
