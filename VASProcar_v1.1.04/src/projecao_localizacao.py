...
print ("==============================================================")
print ("Exemplos:                                                     ")
print ("ion_inicial ion_final: 1  7                                   ")
print ("ion_inicial ion_final: 15 36                                  ")
print ("ion_inicial ion_final: 49 49                                  ")
print ("##############################################################")
print(" ")
...
for i in range(1,(n_reg+1)):
    ...
    print ("==============================================================")
    rotulo = input ("rotulo: "); rotulo = str(rotulo)
    print(" ")
    if (i == 1):
    ...
    print ("==============================================================")
    print (f'Quantos intervalos_de_ions deseja fornecer a REGIAO_{i} ({rotulo})? ')
    print ("==============================================================")   
