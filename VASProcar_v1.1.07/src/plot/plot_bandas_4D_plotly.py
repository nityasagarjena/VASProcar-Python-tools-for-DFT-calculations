...
if (esc == 1 and esc_fermi == 0):
   print(f'E min = {iso_minimo:.8f}')
   print(f'E max = {iso_maximo:.8f}')

if (esc == 1 and esc_fermi == 1):
   print(f'(E-Ef) min = {iso_minimo:.8f}')
   print(f'(E-Ef) max = {iso_maximo:.8f}')

if (esc == 2):
   print(f'|Delta_E| min = {iso_minimo:.8f}')
   print(f'|Delta_E| max = {iso_maximo:.8f}')
