...
rx = psi[:,0]
ry = psi[:,1] + dE_fermi 
ra = psi[:,2]; ra = ((dpi*ra)**2)*peso_total
rb = psi[:,3]; rb = ((dpi*rb)**2)*peso_total
rc = psi[:,4]; rc = ((dpi*rc)**2)*peso_total
rd = psi[:,5]; rd = ((dpi*rd)**2)*peso_total
re = psi[:,6]; re = ((dpi*re)**2)*peso_total
...
for i in range(1,(n_psi+1)):
    if (i == 1): ax.scatter([-1000.0], [-1000.0], s = [40.0], color = [0.0, 0.0, 1.0], alpha = 1.0, edgecolors = 'none', label = l_psi[i-1])
    if (i == 2): ax.scatter([-1000.0], [-1000.0], s = [40.0], color = [1.0, 0.0, 0.0], alpha = 1.0, edgecolors = 'none', label = l_psi[i-1])
    if (i == 3): ax.scatter([-1000.0], [-1000.0], s = [40.0], color = [0.0, 1.0, 0.0], alpha = 1.0, edgecolors = 'none', label = l_psi[i-1])
    if (i == 4): ax.scatter([-1000.0], [-1000.0], s = [40.0], color = [0.737254902, 0.560784313, 0.560784313], alpha = 1.0, edgecolors = 'none', label = l_psi[i-1])
    if (i == 5): ax.scatter([-1000.0], [-1000.0], s = [40.0], color = [1.0, 0.0, 1.0], alpha = 1.0, edgecolors = 'none', label = l_psi[i-1])
