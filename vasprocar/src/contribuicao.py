...
#----------------------------------------------------------------------
read_orb = 1
execute_python_file(filename = DFT + '_nscf_b.py')
            ...
            if ((point_k > point_antes and point_k < point_depois) and (Band_n > Band_antes and Band_n < Band_depois)): 
               for ion_n in range (1, (ni+1)):
                   ...
                   if (total[wp][point_k][Band_n] != 0 and lorbit >= 11):
                      ...
                      if (n_orb == 16):
                         fyx2 = orb[wp][10][point_k][Band_n][ion_n]
                         fxyz = orb[wp][11][point_k][Band_n][ion_n]
                         fyz2 = orb[wp][12][point_k][Band_n][ion_n]
                         fzz2 = orb[wp][13][point_k][Band_n][ion_n]
                         fxz2 = orb[wp][14][point_k][Band_n][ion_n]
                         fzx2 = orb[wp][15][point_k][Band_n][ion_n]
                         fxx2 = orb[wp][16][point_k][Band_n][ion_n]
                         f    = fyx2 + fxyz + fyz2 + fzz2 + fxz2 + fzx2 + fxx2
                      #-------------------------------------------------------
                   ...
                   if (total[wp][point_k][Band_n] != 0 and lorbit == 10):
                      ...
                      if (n_orb == 4):  
                         f = orb[wp][4][point_k][Band_n][ion_n]
                      #--------------------------------------------------
                      contrib_orbitais.write(f'{rotulo[ion_n]:>2}: ion {atomo[ion_n]:<3} | S = {s:5,.2f}% | P = {p:5,.2f}% | D = {d:5,.2f}% | ')
                      if (n_orb == 4):            
               ...
               if (lorbit >= 11):
                  ...
                  if (n_orb == 16):
                     soma_fyx2 = soma_orb[wp][10][point_k][Band_n]
                     soma_fxyz = soma_orb[wp][11][point_k][Band_n]
                     soma_fyz2 = soma_orb[wp][12][point_k][Band_n]
                     soma_fzz2 = soma_orb[wp][13][point_k][Band_n]
                     soma_fxz2 = soma_orb[wp][14][point_k][Band_n]
                     soma_fzx2 = soma_orb[wp][15][point_k][Band_n]
                     soma_fxx2 = soma_orb[wp][16][point_k][Band_n]
                     soma_f    = soma_fyx2 + soma_fxyz + soma_fyz2 + soma_fzz2 + soma_fxz2 + soma_fzx2 + soma_fxx2
                  #-----------------------------------------------------------------------------------------------               
                  contrib_orbitais.write(f'{linha_2} \n')
               ...
               if (lorbit == 10):
                  ...
                  if (n_orb == 4):
                     soma_f = soma_orb[wp][4][point_k][Band_n]
                  #-------------------------------------------              
                  contrib_orbitais.write(f'{linha_1}==== \n')
                  contrib_orbitais.write(f'Sum:        | S = {soma_s:5,.2f}% | P = {soma_p:5,.2f}% | D = {soma_d:5,.2f}% | ')  
                  if (n_orb == 4):
