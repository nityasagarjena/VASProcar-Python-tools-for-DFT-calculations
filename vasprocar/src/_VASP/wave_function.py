...
#-----------------------------------------------------------------------
# Check whether the 'Wave_Function' folder exists ----------------------
#-----------------------------------------------------------------------
if os.path.isdir(dir_files + '/output/Wave_Function'):
   0 == 0
else:
   os.mkdir(dir_files + '/output/Wave_Function')
#-----------------------------------------------
...
#=================================================================================
#=================================================================================
# Wave Function 2D Plot using (GRACE) ============================================
#================================================================================= 
#=================================================================================
...
if (save_agr == 1):
   ...
   print(" ")
   print ("============== Plotando a Funcao de Onda (Grace) ==============")

   execute_python_file(filename = 'plot/Grace/plot_wave_function.py')

   print ("Plot da Funcao de Onda via Grace (arquivo .agr) concluido -----")

#======================================================================
#======================================================================
# Wave Function 2D Plot using (Matplotlib) ============================
#====================================================================== 
#======================================================================  

#======================================================================
# Saving data to plot the Wave Function ===============================
#======================================================================    

#---------------------------------------------------------------------------------
wave_function = open(dir_files + '/output/Wave_Function/Wave_Function_X.dat', "w")
#---------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------
wave_function = open(dir_files + '/output/Wave_Function/Wave_Function_Y.dat', "w")
#---------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------
wave_function = open(dir_files + '/output/Wave_Function/Wave_Function_Z.dat', "w")
#---------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------
# Copy Wave_Function.py to the output folder directory ---------------------------
#---------------------------------------------------------------------------------

try: f = open(dir_files + '/output/Wave_Function/Wave_Function.py'); f.close(); os.remove(dir_files + '/output/Wave_Function/Wave_Function.py')
except: 0 == 0
  
source = main_dir + '/plot/plot_wave_function.py'
destination = dir_files + '/output/Wave_Function/Wave_Function.py'
...
file = open(dir_files + '/output/Wave_Function/Wave_Function.py', 'r')
...
file = open(dir_files + '/output/Wave_Function/Wave_Function.py', 'w')
file.writelines(lines)
file.close()

#-------------------------------------------------------------------------
if (sum_save != 0):
   exec(open(dir_files + '/output/Wave_Function/Wave_Function.py').read())
#-------------------------------------------------------------------------
...
print(" ")
print("============================================================")
print("= Edite o Plot da Funcao de Onda por meio dos arquivos =====")
print("= Wave_Function.py ou .agr (via Grace) gerados na pasta ====")
print("= output/Wave_Function =====================================")   
print("============================================================")
