...
if (save_agr == 1):
   ...
   print(" ")
   print ("============ Plotando a Funcao Dieletrica (Grace): ============")

   execute_python_file(filename = 'plot/Grace/plot_dielectric_function.py')

   print ("Plot da Funcao Dieletrica (arquivo .agr) concluido ------------")
...
linha += 1; lines.insert(linha, f'save_png = {save_png}; save_pdf = {save_pdf}; save_svg = {save_svg}; save_eps = {save_eps}  #  Plotting output format, where [0] = No e [1] = Yes \n')
linha += 1; lines.insert(linha, '\n')
linha += 1; lines.insert(linha, '#===================================================================== \n')
...
print(" ")
print("================================================================")
print("= Edite o Plot da Funcao Dieletrica por meio dos arquivos ======")
print("= Dielectric_Function.py ou .agr (via Grace) gerados na pasta ==")
print("= output/BSE ===================================================")   
print("================================================================")
