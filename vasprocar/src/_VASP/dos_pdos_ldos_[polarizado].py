...
#======================================================================
# Obtendo o numero de orbitais presentes no arquivo DOSCAR ============
#======================================================================
...
if (escolha == -1):
   ...
   if (esc_color == 1):
      ...
      if (n_orb >= 9):
         ...
         if (n_orb == 16):
            print ("=============================================================================") 
            print ("Digite em sequencia as cores da pDOS Fyx2|Fxyz|Fyz2|Fzz2|Fxz2|Fzx2|Fxx2:     ")
   ...
   if (esc == 1):
      ...
      print ("--------------------------------------------------------------")
      print ("intervalos_de_ions: 1:5 7* 11* 15:27                          ")          
      print ("intervalos_de_ions: 7:49 50:53                                ")
      print ("intervalos_de_ions: 3* 8* 16:21                               ")
      print ("##############################################################")
...
dos_u_tot = [0.0]*(NEDOS+1)  # DOS Total (Up)
dos_d_tot = [0.0]*(NEDOS+1)  # DOS Total (Down)

ldos_u    = [0.0]*(NEDOS+1)  # DOS Local (Up)
ldos_d    = [0.0]*(NEDOS+1)  # DOS Local (Down)

lpdos_u   = [[[0.0]*(NEDOS+1) for i in range(ni+1)] for j in range(n_orb+1)]  # DOS Local e Projetada (Up)
lpdos_d   = [[[0.0]*(NEDOS+1) for i in range(ni+1)] for j in range(n_orb+1)]  # DOS Local e Projetada (Down)

pdos_u_S_tot = [0.0]*(NEDOS+1)  # pdos_S Total (Up)
pdos_d_S_tot = [0.0]*(NEDOS+1)  # pdos_S Total (Down)
pdos_u_P_tot = [0.0]*(NEDOS+1)  # pdos_P Total (Up)
pdos_d_P_tot = [0.0]*(NEDOS+1)  # pdos_P Total (Down)
pdos_u_D_tot = [0.0]*(NEDOS+1)  # pdos_D Total (Up)
pdos_d_D_tot = [0.0]*(NEDOS+1)  # pdos_D Total (Down)
pdos_u_F_tot = [0.0]*(NEDOS+1)  # pdos_F Total (Up)
pdos_d_F_tot = [0.0]*(NEDOS+1)  # pdos_F Total (Down)
...
lpdos_u_tot = [[0.0]*(NEDOS+1) for i in range(n_orb+1)]  # Local pdos Total (Up)
lpdos_d_tot = [[0.0]*(NEDOS+1) for i in range(n_orb+1)]  # Local pdos Total (Down)
