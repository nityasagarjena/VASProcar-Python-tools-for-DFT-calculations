...
if (escolha == -1):
   ...
   if (esc_color == 1):
      ...
      print ("==============================================================") 
      print ("Digite em sequencia as cores da pDOS S|P|D|F:                 ")
      ...
      if (n_orb >= 9):
         ...
         print ("==============================================================") 
         print ("Digite em sequencia as cores da pDOS Px|Py|Pz:                ")
         cor_orb = input ("Cores_dos_Orbitais: ")
         #---------------------
         tcor = cor_orb.split()
         ...
         print ("==============================================================") 
         print ("Digite em sequencia as cores da pDOS Dxy|Dyz|Dz2|Dxz|Dx2:     ")
         cor_orb = input ("Cores_dos_Orbitais: ")
         #---------------------
         tcor = cor_orb.split()
   ...
   if (esc == 1):
      ...
      print ("--------------------------------------------------------------")
      print ("intervalos_de_ions: 1:5 7:7 11* 15:27                         ")          
...
dos_tot = [0.0]*(NEDOS+1)  # DOS Total

ldos    = [0.0]*(NEDOS+1)  # DOS Local

lpdos   = [[[0.0]*(NEDOS+1) for i in range(ni+1)] for j in range(n_orb+1)]  # DOS Local e Projetada

pdos_S_tot = [0.0]*(NEDOS+1)  # pdos_S Total
pdos_P_tot = [0.0]*(NEDOS+1)  # pdos_P Total
pdos_D_tot = [0.0]*(NEDOS+1)  # pdos_D Total
pdos_F_tot = [0.0]*(NEDOS+1)  # pdos_F Total
...
lpdos_tot = [[0.0]*(NEDOS+1) for i in range(n_orb+1)]  # Local pdos Total
