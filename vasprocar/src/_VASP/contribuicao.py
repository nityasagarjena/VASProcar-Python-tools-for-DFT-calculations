...
if (escolha == -1 or escolha == 1):
   ...
   print ("##############################################################")
   print ("Selecione por os pontos-k a serem analisados:                 ")
   print ("Digite como nos exemplos abaixo ============================= ")
   print ("------------------------------------------------------------- ")
   print ("Os pontos-k podem ser adicionados em qualquer ordem --------- ")
   print ("------------------------------------------------------------- ")
   print ("intervalos_de_pontos_k  1:50                                  ")          
   print ("intervalos_de_pontos_k  15:25 27:100 150:180 200*             ")
   print ("intervalos_de_pontos_k  70* 90* 110* 130* 140-150             ")
   print ("##############################################################")
   points_range = input ("intervalos_de_pontos_k  ")
   print (" ")
   #--------------------------------------------------------------------------------------------
   ...
   for i in range (1,(loop+1)):
       ...
       if ((loop_i > nk) or (loop_f > nk) or (loop_i < 0) or (loop_f < 0) or (loop_i > loop_f)):
          print (" ")
          print ("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
          print ("ERRO: Os valores de pontos-k informados estao incorretos %%")
          print ("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
          confirmacao = input (" ")
          exit() 
       #-----------------------------------------------------------------------     
    ...
    for n_spin in range(1,(ispin+1)):
        ...
        for point_k in range(1, (nk+1)):                       
            ...
            for Band_n in range (1, (int(nb/ispin) +1)):
                ...
                ###########################################################################
                # Calculando a procentagem de contribuicao de cada Orbital: ###############
                ###########################################################################
                ...
                ###########################################################################
                # Calculando a procentagem de contribuicao de cada ion: ###################
                ###########################################################################               
                ...
                for ion_n in range (1,(ni+1)):
                    ...
                    if (total != 0):
                       contrib_ions.write(f'{rotulo_temp[ion_n]:>2}: ion {atomo[ion_n]:<3} | Contributiono: {tot_ion[ion_n]:>6,.3f}% | Sum:  {soma:>7,.3f}% | \n')
