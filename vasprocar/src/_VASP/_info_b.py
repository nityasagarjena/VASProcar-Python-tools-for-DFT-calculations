...
# ----------------------------------------------------------------------
# Verificando a quantidade de orbitais no arquivo PROCAR: --------------
# ----------------------------------------------------------------------
...
VTemp = outcar.readline().split()
lnoncollinear = VTemp[2]                       # Leitura do valor associado a variavel LNONCOLLINEAR.
...
if (lnoncollinear == "F"):
   LNC = 1
   inform.write("LNONCOLLINEAR = .FALSE. (Calculo Collinear) \n")
if (lnoncollinear == "T"):
   LNC = 2
   inform.write("LNONCOLLINEAR = .TRUE. (Calculo Não-Collinear) \n")
