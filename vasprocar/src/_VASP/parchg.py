...
if (save_agr == 1):
   ...
   print(" ")
   print ("======== Plotando a Densidade Parcial de Carga (Grace) ========")
  
   execute_python_file(filename = 'plot/Grace/plot_parchg.py')

   print ("Plot da Densidade Parcial de Carga via Grace (arquivo .agr) concluido")
...
print(" ")
print("==============================================================")
print("= Edite o Plot da Densidade por meio dos arquivos Densidade.py")
print("= ou .agr (via Grace) gerados na pasta =======================")   
