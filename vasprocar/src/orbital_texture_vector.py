...
if (escolha == -1):
   ...
   print ("##############################################################")
   print ("Do you want to label the energies on the Contours? ===========")
   print ("[0] NO                                                        ")
   print ("[1] YES                                                       ")
   print ("##############################################################")
...
phase = open(dir_files + '/output/Phase_factors.dat', "r")
orb_texture = open(dir_files + '/output/Orbital_Texture/Orbital_Texture.dat', 'w')
#---------------------------------------------------------------------------------
...
for i in range (n_procar*nk):
    ...
    if (Dimensao != 4):
       orb_texture.write(f'{kx} {ky} {kz} {energia[i]} {Px*(fr_px)} {Py*(fr_py)} {Pz*(fr_pz)} \n')      
    if (Dimensao == 4):
       orb_texture.write(f'{k1} {k2} {k3} {energia[i]} {Px*(fr_px)} {Py*(fr_py)} {Pz*(fr_pz)} \n')
...
os.remove(dir_files + '/output/Phase_factors.dat')

#======================================================================
# Copy Orbital_Texture_Vector.py to the output folder directory =======
#======================================================================

try: f = open(dir_files + '/output/Orbital_Texture/Orbital_Texture_Vector.py'); f.close(); os.remove(dir_files + '/output/Orbital_Texture/Orbital_Texture_Vector.py')
except: 0 == 0
   
source = main_dir + '/plot/plot_orbital_texture_vector.py'
destination = dir_files + '/output/Orbital_Texture/Orbital_Texture_Vector.py'
...
file = open(dir_files + '/output/Orbital_Texture/Orbital_Texture_Vector.py', 'r')
...
file = open(dir_files + '/output/Orbital_Texture/Orbital_Texture_Vector.py', 'w')
file.writelines(lines)
file.close()

#---------------------------------------------------------------------------------
exec(open(dir_files + '/output/Orbital_Texture/Orbital_Texture_Vector.py').read())
#---------------------------------------------------------------------------------
...
print("= [factor], [thickness] and [length] in the Orbital_Texture_Vector.py =")
print("= file generated in the output/Orbital_Texture folder. ================")
print("=======================================================================")
