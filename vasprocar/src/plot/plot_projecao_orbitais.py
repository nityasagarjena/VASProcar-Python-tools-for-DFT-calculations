...
for l in range (1,(loop+1)):     # Loop para a analise das Projecoes
    ...
    if (l == 1):
       if (n_orb == 3 or n_orb == 9):  print ("Plot da projecao dos orbitais S|P|D concluido --------------------------------")
       if (n_orb == 4 or n_orb == 16): print ("Plot da projecao dos orbitais S|P|D|F concluido ------------------------------")
    if (l == 2):
       print ("Plot da projecao dos orbitais Px|Py|Pz concluido -----------------------------")
    if (l == 3):
       print ("Plot da projecao dos orbitais Dxy|Dyz|Dz2|Dxz|Dx2 concluido ------------------")
    if (l == 4):      
       print ("Plot da projecao dos orbitais Fyx2|Fxyz|Fyz2|Fzz2|Fxz2|Fzx2|Fxx2 concluido ---")
...
for Band_n in range (1, (num_bands+1)):
    for wp in range (1, (n_procar+1)):
        for point_k in range (1, (nk+1)):       
            ...
            #--------------------------------------------------------------------------------------------------
            # Somando as cores dos orbitais (S,P,D,F): --------------------------------------------------------
            #--------------------------------------------------------------------------------------------------
            ...
            #---------------------------------------------------------------------------------------------------
            # Somando as cores dos orbitais (Fyx2,Fxyz,Fyz2,Fzz2,Fxz2,Fzx2,Fxx2): ------------------------------
            #---------------------------------------------------------------------------------------------------
