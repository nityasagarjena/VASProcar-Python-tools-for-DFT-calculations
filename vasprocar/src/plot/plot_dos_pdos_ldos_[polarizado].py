...
for l in range (1,(loop+1)):     # Loop para a analise das Projecoes
    ...
    if (l == 1):
       ...
       if (n_orb == 4 or n_orb == 16):
          print ("Analisando a DOS e pDOS (S|P|D|F)") 
       #---------------------------------------------------
    ...
    if (l == 4):
       print ("Analisando a pDOS (Fyx2|Fxyz|Fyz2|Fzz2|Fxz2|Fzx2|Fxx2)") 
       #---------------------------------------------------------
       pdos_u_F = dos_up[:,9];      pdos_d_F = dos_down[:,9]
...
for l in range (1,(loop+1)):     # Loop para a analise das Projecoes
    ...
    if (l == 4):
       print ("Analisando a Magnetizacao (Fyx2|Fxyz|Fyz2|Fzz2|Fxz2|Fzx2|Fxx2)") 
       #-----------------------------------------------------------------------
       pdos_F   = dos_up[:,9]   + dos_down[:,9]       
