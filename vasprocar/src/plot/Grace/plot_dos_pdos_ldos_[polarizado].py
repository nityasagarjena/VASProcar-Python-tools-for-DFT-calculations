...
cor_orb = [7]*(23)
#-----------------
cor_orb[1]  = c_S; cor_orb[2]  = c_P; cor_orb[3]  = c_D  # Cor da pDOS S,P,D (Up)
cor_orb[4]  = c_S; cor_orb[5]  = c_P; cor_orb[6]  = c_D  # Cor da pDOS S,P,D (Down)
cor_orb[7]  = c_Px; cor_orb[8]  = c_Py; cor_orb[9]  = c_Pz  # Cor da pDOS Px,Py,Pz (Up)
cor_orb[10] = c_Px; cor_orb[11] = c_Py; cor_orb[12] = c_Pz  # Cor da pDOS Px,Py,Pz (Down)
cor_orb[13] = c_Dxy; cor_orb[14] = c_Dyz; cor_orb[15] = c_Dz2; cor_orb[16] = c_Dxz; cor_orb[17] = c_Dx2  # Cor da pDOS Dxy,Dyz,Dz2,Dxz,Dx2 (Up)
cor_orb[18] = c_Dxy; cor_orb[19] = c_Dyz; cor_orb[20] = c_Dz2; cor_orb[21] = c_Dxz; cor_orb[22] = c_Dx2  # Cor da pDOS Dxy,Dyz,Dz2,Dxz,Dx2 (Down)
