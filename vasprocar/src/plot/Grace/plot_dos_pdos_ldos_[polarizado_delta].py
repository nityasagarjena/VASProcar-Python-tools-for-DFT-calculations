...
cor_orb = [7]*(12)
#-----------------
cor_orb[1] = c_S;  cor_orb[2] = c_P;  cor_orb[3] = c_D   # Cor da pDOS S,P,D
cor_orb[4] = c_Px; cor_orb[5] = c_Py; cor_orb[6] = c_Pz  # Cor da pDOS Px,Py,Pz
cor_orb[7] = c_Dxy; cor_orb[8] = c_Dyz; cor_orb[9] = c_Dz2; cor_orb[10] = c_Dxz; cor_orb[11] = c_Dx2  # Cor da pDOS Dxy,Dyz,Dz2,Dxz,Dx2
