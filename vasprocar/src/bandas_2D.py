...
if (escolha == -1):
   ...
   print ("[0] Plotar todas as bandas ===================================")
   print ("[1] Plotar bandas selecionadas ===============================")
   print ("##############################################################")
   ...
   if (esc_bands == 1):     
      print ("##############################################################")
      print ("Escolha as bandas a serem plotadas por meio de intervalos:    ")
...
if (save_agr == 1):
   ...
   print(" ")
   print ("================= Plotando as bandas (Grace): =================")

   execute_python_file(filename = 'plot/Grace/plot_bandas_2D.py')

   print ("Plot das Bandas via Grace (arquivo .agr) concluido ------------")
...
linha += 1; lines.insert(linha, f'bands_range = "{bands_range}"  # Bandas a serem plotadas \n')
