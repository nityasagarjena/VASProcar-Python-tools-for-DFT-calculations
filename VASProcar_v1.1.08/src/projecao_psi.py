...
psi = [[[[0.0]*(nb+1) for i in range(nk+1)] for j in range(n_procar+1)] for k in range(6+1)]  #  psi[n_psi][n_procar][nk][nb]          
...
print ("==============================================================")
print ("Para um mesmo intervalo de ions, separe os orbitais por +     ")
print ("==============================================================")
print ("Exemplos:                                                     ")
if (lorbit == 10):
   print ("intervalos_de_ions orbitais  3:3 s+p+d                        ")
   print ("intervalos_de_ions orbitais  5:14 s+p 15:36 s+d               ")
   print ("intervalos_de_ions orbitais  14:49 s 50:51 p 52:52 d          ")
if (lorbit >= 11):
   print ("intervalos_de_ions orbitais  15:27 s+pz 28:36 px+py 37:37 d   ")  
   print ("intervalos_de_ions orbitais  35:78 s+pz+dxz+dx2               ")
   print ("intervalos_de_ions orbitais  9:9 s+p+d 10:14 pz 15:15 px+py   ")
   print ("##############################################################")
print(" ")
...
for i in range(1,(n_psi+1)):
    ...
    print (" ")
    psi_io = input ("intervalos_de_ions orbitais  ").replace(':', ' ').split( )
    print (" ")
