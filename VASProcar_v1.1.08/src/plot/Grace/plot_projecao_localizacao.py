...
for i in range (1,(6+1)):
    #-----------------------
    legenda = label_reg[i-1]
    #-----------------------
    if (i == 1): grac='s0'; color = c_Reg1
    if (i == 2): grac='s1'; color = c_Reg2
    if (i == 3): grac='s2'; color = c_Reg3
    if (i == 4): grac='s3'; color = c_Reg4
    if (i == 5): grac='s4'; color = c_Reg5
    if (i == 6): grac='s5'; color = c_Reg6
    ...
    if (i == 1 and num_A == 1): projection.write(f'@    {grac} legend  "{legenda}" \n')
    if (i == 2 and num_B == 1): projection.write(f'@    {grac} legend  "{legenda}" \n')
    if (i == 3 and num_C == 1): projection.write(f'@    {grac} legend  "{legenda}" \n')
    if (i == 4 and num_D == 1): projection.write(f'@    {grac} legend  "{legenda}" \n')
    if (i == 5 and num_E == 1): projection.write(f'@    {grac} legend  "{legenda}" \n')   
    if (i == 6 and num_F == 1): projection.write(f'@    {grac} legend  "{legenda}" \n')
...
for j in range(nb + 1 + contador2):
    ...
    #-----------------------------------------------------
    projection.write(f'@    s{j+6} type xysize \n')
    projection.write(f'@    s{j+6} line type 1 \n')
    projection.write(f'@    s{j+6} line color {color} \n')    
    #-----------------------------------------------------       
    ...
    for Band_n in range (1,(nb+1)):
        for wp in range (1,(n_procar+1)):
            for point_k in range (1,(nk+1)):
                ...
                if (Prop[t][wp][point_k][Band_n] > 0.0):  
                   projection.write(f'{xx[wp][point_k]} {Energia[wp][point_k][Band_n] + dE_fermi} {Prop[t][wp][point_k][Band_n]*peso_total} \n')
