...
# Escrita do arquivo ".agr" do GRACE ===================================
    ...
    for i in range (1,(3+1)):
        ...
        if (i == 1):
           grac='s0'; color = c_spin_up; legenda = letras + ' \\f{Symbol}\\c-\\C'   # Cor (Vermelho) da componente Up dos Spins Sx, Sy e Sz.
        if (i == 2):
           grac='s1'; color = c_spin_down; legenda = letras + ' \\f{Symbol}\\c/\\C'   # Cor (Azul) da componente Down dos Spins Sx, Sy e Sz.
        if (i == 3):
           grac='s2'; c_spin_null; legenda = ''                               # Cor (Preto) da componente Nula dos Spins Sx, Sy e Sz.
        ...
        for wp in range (1, (n_procar+1)):
            for point_k in range (1, (nk+1)):
                for Band_n in range (1, (nb+1)):
                    #----------------------------------
                    if (t == 1):
                       si = tot_sx[wp][point_k][Band_n]*peso_total
                    if (t == 2):
                       si = tot_sy[wp][point_k][Band_n]*peso_total
                    if (t == 3):
                       si = tot_sz[wp][point_k][Band_n]*peso_total
                    #-------------------------------------------------------------------------------
